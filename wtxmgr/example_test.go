...
func ExampleStore_Balance() {
	...
	// Insert a transaction which outputs 10 HDF unmined and mark the output
	// as a credit.
...
func ExampleStore_Rollback() {
	...
	err = walletdb.Update(db, func(tx walletdb.ReadWriteTx) error {
		...
		// Insert a transaction which outputs 10 HDF in a block at height 100.
...
func Example_basicUsage() {
	...
	// Insert an unmined transaction that outputs 10 HDF to a wallet address
	// at output 0.
	...
	// outputs.  Mark the second one (5 HDF) as wallet change.
