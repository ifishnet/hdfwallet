...
hdfwallet will not drop transaction history by itself, as this is something that
...
```
$ cd $GOPATH/src/github.com/hdfsuite/hdfwallet/cmd/dropwtxmgr
$ go get
```
...
```
$ dropwtxmgr
Database path: /home/username/.hdfwallet/mainnet/wallet.db
Drop all hdfwallet transaction history? [y/N] y
...
```
$ dropwtxmgr --db ~/.hdfwallet/testnet/wallet.db
Database path: /home/username/.hdfwallet/testnet/wallet.db
Drop all hdfwallet transaction history? [y/N] y
Dropping wtxmgr namespace
```

After dropping transaction history, hdfwallet may be restarted and a full rescan
will be triggered to sync the wallet:

```
$ hdfwallet
14:05:31 2015-04-13 [INF] HDFW: No recorded transaction history -- needs full rescan
...
