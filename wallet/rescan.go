...
type RescanJob struct {
	...
	OutPoints   map[wire.OutPoint]hdfutil.Address
...
// rescan.
func (w *Wallet) Rescan(addrs []hdfutil.Address, unspent []wtxmgr.Credit) error {
...
func (w *Wallet) rescanWithTarget(addrs []hdfutil.Address,
	unspent []wtxmgr.Credit, startStamp *waddrmgr.BlockStamp) error {

	outpoints := make(map[wire.OutPoint]hdfutil.Address, len(unspent))
