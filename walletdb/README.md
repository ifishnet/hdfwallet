...
Package walletdb provides a namespaced database interface for hdfwallet.
...
[![GoDoc](https://godoc.org/github.com/hdfsuite/hdfwallet/walletdb?status.png)]
(http://godoc.org/github.com/hdfsuite/hdfwallet/walletdb)
...
http://localhost:6060/pkg/github.com/hdfsuite/hdfwallet/walletdb

## Installation

```bash
$ go get github.com/hdfsuite/hdfwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/hdfsuite/hdfwallet/walletdb#example-package--BasicUsage)  
