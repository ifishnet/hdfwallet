...
func (c *RPCClient) Rescan(startHash *chainhash.Hash, addrs []hdfutil.Address,
	outPoints map[wire.OutPoint]hdfutil.Address) error {
...
// parseBlock parses a hdfws definition of the block a tx is mined it to the
...
func parseBlock(block *hdfjson.BlockDetails) (*wtxmgr.BlockMeta, error) {
	if block == nil {
		return nil, nil
	}
...
func (c *RPCClient) onRecvTx(tx *hdfutil.Tx, block *hdfjson.BlockDetails) {
...
func (c *RPCClient) onRedeemingTx(tx *hdfutil.Tx, block *hdfjson.BlockDetails) {
