...
func TestBlockFiltererOneInOneOut(t *testing.T) {
	...
	watchedOutPoints[firstTx.TxIn[0].PreviousOutPoint] = &hdfutil.AddressWitnessPubKeyHash{}
	watchedOutPoints[lastTx.TxIn[0].PreviousOutPoint] = &hdfutil.AddressWitnessPubKeyHash{}
